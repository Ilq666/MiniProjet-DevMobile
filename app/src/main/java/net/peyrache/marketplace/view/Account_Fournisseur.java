...
public class Account_Fournisseur extends Fragment {

    private Fournisseur utilFo, initUserFo;
    ...
    private CutilFournisseur cutil;
    private Context context;
    private CpageAccueil cpageAccueil;

    public Account_Fournisseur(Fournisseur fournisseur){
        this.utilFo= fournisseur;
    }
    @Nullable
    @Override
    ...
    private void init(View view) {
        ...
        Fournisseur utilisateur = cpageAccueil.getConnexionFO(utilFo.getUsername());
        initUserFo=utilFo;
        ...
        cutil = new CutilFournisseur(context);

        ecouteurModif(utilisateur);
    }

    private void ecouteurModif(final Fournisseur utilisateur) {
               ...
               String mail_modif_utilFoSTR = mail_modif_utilFo.getText().toString();
                ...
                if(utilisateur.getRaisonSociale().equals(rs_modif_utilFoSTR) && utilisateur.getRib().equals(rib_modif_utilFoSTR)
                    ...
                    Toast.makeText(context, "Vous n'avez rien modifié", Toast.LENGTH_SHORT).show();
                        ...
                        reload.detach(Account_Fournisseur.this).attach(Account_Fournisseur.this).commit();
                }
            }
        });
    }
