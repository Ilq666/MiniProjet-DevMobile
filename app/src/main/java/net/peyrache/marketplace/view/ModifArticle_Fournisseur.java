...
public class ModifArticle_Fournisseur extends Fragment {
    ...
    public ModifArticle_Fournisseur(Article article, Fournisseur utilFo){
    ...
    private void ecouteurAnnuler(final Context context) {
        annuler.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                home = new Home_Fournisseur(utilFo);
        ...
        valider.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    cutilFournisseur.articleUpdate(article.getNomArticle(), descriptionSTR,prixFLOAT, qteINT, idUtilisateur);
