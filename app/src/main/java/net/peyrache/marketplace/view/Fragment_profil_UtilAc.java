...
public class Fragment_profil_UtilAc extends Fragment {
    ...
    public Fragment_profil_UtilAc(Client utilisateur){
    ...
    private void init(Context context, View view) {
        ...
        utilisateur = cpageAccueil.getConnexionAC(client.getUsername());
    ...
    private void ecouteurModif(final Context context, final Client utilisateur) {
        modifProfilUtilAc.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(utilisateur.getPassword().equals(modif_password_utilACSTR)
                    ...
                    cutilClient.updateUtilAc(client.getUsername(), modif_password_utilACSTR, modifEmailUtilAcSTR,
