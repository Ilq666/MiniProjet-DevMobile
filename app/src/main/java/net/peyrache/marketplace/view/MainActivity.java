        ...
        connexionBT.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (verif.equals("ac")){
                    ...
                    Client connexionAc = controle.getConnexionAC(username);
                    ...
                    intent_utilAc=new Intent(MainActivity.this, ClientPages.class);
                    ...
                    Fournisseur connexionFo = controle.getConnexionFO(username);
                    ...
                    intent_utilFo = new Intent(MainActivity.this, FournisseurPages.class);
