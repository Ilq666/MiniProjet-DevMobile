...
public class ClientPages extends AppCompatActivity {
    ...
    private void init(){
        ...
        intent= getIntent();
        utilisateur=(Client)intent.getParcelableExtra("utilisateur");
        ecouteurBottomNav();
    }
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId()){
                    case R.id.nav_home:
                        fragmentSelected= new Home_Client(utilisateur);
                        break;
