...
public class DataBaseSqlLite extends SQLiteOpenHelper {
     ...
     */
    public Client connexionAC(String username){
        Client utilisateur;
        ...
        while(!(cursor.isAfterLast())){
            ...
            utilisateur = new Client(cursor.getString(0), cursor.getString(1),
     ...
     */
    public Fournisseur connexionFo(String username){
        ...
        while(!(cursor.isAfterLast())){
            ...
            utilisateur = new Fournisseur(cursor.getInt(0), cursor.getString(1), cursor.getString(2),
